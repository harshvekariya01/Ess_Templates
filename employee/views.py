...
def userpuch_in(request):
    ...
    data=attendence.objects.create(punch_in=puchin,date=date.today()
,employee_name=user.employee_user) 
    print('puchin====================',puchin)  
